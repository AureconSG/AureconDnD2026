...
function updateCountdown() {
  ...
  const label = `${values.days} days, ${values.hours} hours, ${values.minutes} minutes and ${values.seconds} seconds remaining`;
  document.querySelectorAll("[data-countdown]").forEach((element) => element.setAttribute("aria-label", label));
}
